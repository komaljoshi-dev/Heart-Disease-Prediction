...
cleveland.to_csv("data/interim/cleveland.csv",index=False)
hungarian.to_csv("data/interim/hungarian.csv",index=False)
switzerland.to_csv("data/interim/switzerland.csv",index=False)
